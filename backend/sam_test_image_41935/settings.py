"""
Django settings for sam_test_image_41935 project.
...
ROOT_URLCONF = 'sam_test_image_41935.urls'
...
WSGI_APPLICATION = 'sam_test_image_41935.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_test_image_41935 API",
    "DESCRIPTION": "API documentation for sam_test_image_41935 App",
    "VERSION": "v1",
}
